export class UI {
    ...
    init() {
        ...
        this.modal = document.getElementById('savePresetMoal')
    ...
    createSoundCard(sound) {
        ...
        card.className = 'sound-card bg-white/10 backdrop-blur-md rounded-2xl p-6 relatvie overflow-hidden transition-all duration-300';
